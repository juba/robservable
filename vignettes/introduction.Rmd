...
If you need to display an unnamed cell, you can do it by specifying its number, *ie* its position in the notebook. For example, to display the first cell of a notebook if it is unnamed you would do :
