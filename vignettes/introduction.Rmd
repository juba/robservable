...
If you need to display an unnamed cell, you can do it by specifying its number, *ie* its position in the notebook. The position is 0-based indexed, so to display the first cell of a notebook you would do :
...
Note that specifying a named cell by its position will not display it : you have to add its name to `cell`. 
